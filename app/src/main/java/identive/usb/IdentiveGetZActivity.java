    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        spin.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
            {
        		...
        		switch(pos){
	    			case 0:  nItemSelected = WinDefs.SCARD_ATTR_VENDOR_NAME;
	    						break;
	    			case 1:  nItemSelected = WinDefs.SCARD_ATTR_VENDOR_IFD_TYPE;
	    						break;
	    			case 2:  nItemSelected = WinDefs.SCARD_ATTR_VENDOR_IFD_VERSION;
	    						bAttrFlag = 1;
	    						break;
	    			case 3:  nItemSelected = WinDefs.SCARD_ATTR_VENDOR_IFD_SERIAL_NO;
	    						break;
	    			case 4:  nItemSelected = WinDefs.SCARD_ATTR_CHANNEL_ID;
	    						bAttrFlag = 1;
	    						break;
	    			case 5:  nItemSelected = WinDefs.SCARD_ATTR_PROTOCOL_TYPES;
	    						bAttrFlag = 1;
	    						break;
	    			case 6:  nItemSelected = WinDefs.SCARD_ATTR_DEFAULT_CLK;
	    						bAttrFlag = 2;
	    						break;
	    			case 7:  nItemSelected = WinDefs.SCARD_ATTR_MAX_CLK;
	    						bAttrFlag = 2;
	    						break;
	    			case 8:  nItemSelected = WinDefs.SCARD_ATTR_DEFAULT_DATA_RATE;
	    						bAttrFlag = 2;
	    						break;
	    			case 9:  nItemSelected = WinDefs.SCARD_ATTR_MAX_DATA_RATE;
	    						bAttrFlag = 2;
	    						break;
	    			case 10:  nItemSelected = WinDefs.SCARD_ATTR_MAX_IFSD;
				    			bAttrFlag = 2;
								break;
	    			case 11:  nItemSelected = WinDefs.SCARD_ATTR_POWER_MGMT_SUPPORT;
				    			bAttrFlag = 2;
								break;
	    			case 12:  nItemSelected = WinDefs.SCARD_ATTR_CHARACTERISTICS;
				    			bAttrFlag = 1;
								break;
	    			case 13:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_PROTOCOL_TYPE;
				    			bAttrFlag = 1;
								break;
	    			case 14:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_CLK;
				    			bAttrFlag = 2;
								break;
	    			case 15:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_F;
				    			bAttrFlag = 2;
								break;
	    			case 16:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_D;
				    			bAttrFlag = 2;
								break;
	    			case 17:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_N;
				    			bAttrFlag = 2;
								break;
	    			case 18:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_W;
				    			bAttrFlag = 2;
								break;
	    			case 19:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_IFSC;
				    			bAttrFlag = 2;
								break;
	    			case 20:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_IFSD;
				    			bAttrFlag = 2;
								break;
	    			case 21:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_BWT;
				    			bAttrFlag = 2;
								break;
	    			case 22:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_CWT;
				    			bAttrFlag = 2;
								break;
	    			case 23:  nItemSelected = WinDefs.SCARD_ATTR_CURRENT_EBC_ENCODING;
				    			bAttrFlag = 2;
								break;
	    			case 24:  nItemSelected = WinDefs.SCARD_ATTR_ICC_PRESENCE;
	    						bAttrFlag = 1;
								break;
	    			case 25:  nItemSelected = WinDefs.SCARD_ATTR_ICC_INTERFACE_STATUS;
	    						bAttrFlag = 1;
								break;
	    			case 26:  nItemSelected = WinDefs.SCARD_ATTR_ATR_STRING;
	    						bAttrFlag = 1;
								break;
	    			case 27:  nItemSelected = WinDefs.SCARD_ATTR_ICC_TYPE_PER_ATR;
	    						bAttrFlag = 1;
								break;
					case 28:  nItemSelected = WinDefs.SCARD_ATTR_DEVICE_UNIT;
								break;
    				case 29:  nItemSelected = WinDefs.SCARD_ATTR_DEVICE_IN_USE;
								break;
    				case 30:  nItemSelected = WinDefs.SCARD_ATTR_DEVICE_FRIENDLY_NAME;
								break;
    				case 31:  nItemSelected = WinDefs.SCARD_ATTR_DEVICE_SYSTEM_NAME;
								break;
        		}
    	    }
				...
				if(charray1.length == charray2.length){
					for(int l = 0; l < charray1.length; l++){
						if(charray2[l] == 'x' || charray2[l] == 'X' || charray2[l] == charray1[l]){
							...
							Toast.makeText(getBaseContext(), "Transmission Error", Toast.LENGTH_SHORT).show();
						}
					}
				}else{
					Toast.makeText(getBaseContext(), "Transmission Error", Toast.LENGTH_SHORT).show();
